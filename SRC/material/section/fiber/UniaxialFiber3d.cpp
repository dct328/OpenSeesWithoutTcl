...
//new UniaxialFiber3d(numUniaxialFiber3d++,*theMat,data[2],fiberPos);
...
UniaxialFiber3d::UniaxialFiber3d(int tag, 
                                 ...
                                 double Area, double locx, double locy)
...
UniaxialFiber3d::getCopy (void)
{
   ...
   UniaxialFiber3d *theCopy = new UniaxialFiber3d (this->getTag(), *theMaterial, area, locx, locy);
   return theCopy;
}  
