...
:SP_Constraint(CNSTRNT_TAG_ImposedMotionSP), patternTag(0), theNode(0), theNodeResponse(0), theGroundMotionResponse(3)
...
ImposedMotionSP::ImposedMotionSP(int node, int ndof, int pattern, GroundMotion &theGroundMotion1)
:SP_Constraint(node, ndof, CNSTRNT_TAG_ImposedMotionSP), patternTag(pattern), theGroundMotion(&theGroundMotion1), theNode(0), theNodeResponse(0), theGroundMotionResponse(3)
{
