...
// $Source: /usr/local/cvs/OpenSees/SRC/element/Truss2D/Truss2D.h,v $
...
#include <Vector.h>
#include <Channel.h>
#include </home/chenting/Chenting/OpenSees/SRC/element/forceBeamColumn/BeamIntegration.h>
#include </home/chenting/Chenting/OpenSees/SRC/material/section/SectionForceDeformation.h>
#include <CrdTransf.h>
...
class Truss2D: public Element
{
 public:
  Truss2D();
  Truss2D(int tag, int nodeI, int nodeJ,
  ...
  ~Truss2D();
  const char *getClassType(void) const {return "Truss2D";};
  ...
  friend OPS_Stream &operator<<(OPS_Stream &s, Truss2D &E);
